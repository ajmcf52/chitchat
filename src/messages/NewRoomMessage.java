...
public class NewRoomMessage extends Message {
    ...
    /**
     * Used for debugging purposes on the side of the Registry. No user-facing
     * application of this method here.
     * 
